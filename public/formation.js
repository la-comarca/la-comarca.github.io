...
function initPrayerbook(){
 ...
 root.dataset.readingLanguage='both';root.dataset.readingSize='normal';root.querySelectorAll('[data-prayer-language]').forEach(button=>button.setAttribute('aria-pressed',String(button.dataset.prayerLanguage==='both')));root.querySelector('.prayer-language')?.removeAttribute('hidden');size?.closest('label')?.setAttribute('hidden','');
